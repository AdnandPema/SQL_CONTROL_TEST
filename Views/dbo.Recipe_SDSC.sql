...
AND CONVERT(time,getdate(),108)  < EndTime 
and ( a.[Column Name] = 'Item Category Code' and b.Value = 'Artikulli' and F.AValue = 'Artikulli' and Recipes_Trigger.RecipesDescription='Specifick discount for specific category')
